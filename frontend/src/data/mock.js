// Mock data for Galo Logistics Amazon DSP website
export const mockData = {
  company: {
    name: "Galo Logistics",
    tagline: "Your Trusted Amazon DSP Partner",
    founded: "2019",
    phone: "(561) 555-0123",
    email: "info@galologistics.com",
    address: "Serving Palm Beach County, FL",
    serviceArea: "Boca Raton to West Palm Beach"
  },
  ...
  images: {
    hero: {
      background: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80',
  ...
  submitContactForm: async (formData) => {
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve({
          success: true,
          message: "Thank you for contacting Galo Logistics. We'll get back to you within 24 hours."
        });
      }, 1000);
    });
  },
